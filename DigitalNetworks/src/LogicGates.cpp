...
int main()
{
    ...
    circuito = " ( ( ( ( ( not A ) nand B ) or C ) or ( C or A ) )  ";
    Circuit F;
    Signals A, B, C;
    A.name = "A";
    A.value = 1;
    ...
    S.push_back(B);
    S.push_back(C);
    cout << "Para ver o grafo gerado, copie o código abaixo e cole em http://graphs.grevian.org/graph , ou outro visualizado .dot de sua preferência." << endl << endl;
